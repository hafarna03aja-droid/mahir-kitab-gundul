          ...
          <div className="space-y-8 text-gray-700 leading-relaxed">
            ...
            <section className="pt-6 border-t mt-8">
              <p className="text-sm text-gray-500">
                Jika ada pertanyaan mengenai Syarat & Ketentuan ini, silakan hubungi kami di: <a href="mailto:admin@mahirarab.com" className="text-blue-600 hover:underline">admin@mahirarab.com</a>
              </p>
            </section>
          </div>
        </div>
