                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            },
                            {
                                ...
                                a: 'Kami menggunakan sistem kuota harian untuk penggunaan fair. Untuk power user, tersedia opsi BYO API Key dimana Anda bisa menggunakan API key Google Gemini pribadi.'
                            },
                            {
                                q: 'Apakah hasil analisis AI 100% benar?',
                                a: 'AI kami memiliki akurasi 90%+ untuk analisis gramatikal umum. Namun, untuk teks yang sangat kompleks, kami tetap menyarankan verifikasi dengan guru/ustadz.'
                            }
                        ].map((faq, i) => (
