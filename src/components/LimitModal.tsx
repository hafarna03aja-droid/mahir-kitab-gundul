        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm transition-opacity animate-in fade-in duration-200">
            ...
            >
                <div className="flex flex-col items-center text-center">
                    {/* Icon */}
                    <div className={`mb-5 p-3 rounded-full ${isDaily ? 'bg-amber-100 text-amber-600' : 'bg-red-100 text-red-600'}`}>
                        {isDaily ? (
                    ...
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">
                        {isDaily ? "Kuota Harian Tercapai" : "Langganan Berakhir"}
                    </h3>
