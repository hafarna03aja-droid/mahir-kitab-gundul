...
const KitabTab: React.FC = () => {
    ...
    const ajurrumiyahContent: KitabContent[] = [
        {
            chapter: 1,
            title: 'Muqaddimah',
            content: [
                ...
                'وحروف الخفض وهي: من وإلى وعن وعلى وفي ورب والباء والكاف واللام',
            ],
            translation: [
                'Kalam adalah lafaz yang tersusun yang berfaidah menurut aturan bahasa Arab',
                'Dan pembagiannya ada tiga: isim (kata benda), fi\'il (kata kerja), dan huruf yang datang untuk makna tertentu',
                'Maka isim dikenali dengan khafadh (kasrah), tanwin, dan masuknya alif lam',
                'Dan huruf-huruf khafadh (jarr) yaitu: min, ila, \'an, \'ala, fi, rubba, ba, kaf, dan lam',
            ],
            footnotes: [
                'Definisi kalam menurut ulama Nahwu: minimal 2 kata yang memberikan faidah sempurna',
                'Tiga pembagian dasar dalam ilmu Nahwu yang harus dikuasai pemula',
                'Tanda-tanda isim yang mudah dikenali oleh pemula dalam belajar Nahwu',
                'Huruf jarr ada 21 macam, ini adalah yang paling sering digunakan',
            ]
        },
        {
            chapter: 2,
            ...
            translation: [
                'I\'rab adalah perubahan akhir kata karena perbedaan \'amil yang masuk padanya, baik secara lafaz atau perkiraan',
                'Dan pembagiannya ada empat: rafa\', nashab, khafadh (jarr), dan jazm',
                'Maka untuk isim dari itu ada rafa\', nashab, dan khafadh, tidak ada jazm padanya',
                'Dan untuk fi\'il dari itu ada rafa\', nashab, dan jazm, tidak ada khafadh padanya',
            ],
            footnotes: [
                'I\'rab adalah konsep paling penting dalam Nahwu: perubahan harakat akhir kata',
                'Empat jenis i\'rab yang harus dikuasai untuk membaca dan menulis Arab dengan benar',
                'Isim (kata benda) tidak pernah di-jazm, hanya bisa rafa\', nashab, atau jarr',
                'Fi\'il (kata kerja) tidak pernah di-jarr, hanya bisa rafa\', nashab, atau jazm',
            ]
        },
        {
            chapter: 3,
            ...
            content: [
                ...
                'في الاسم المفرد وجمع التكسير وجمع المؤنث السالم والفعل المضارع',
                'وأما الواو فتكون علامة للرفع في موضعين: في جمع المذكر السالم وفي الأسماء الخمسة',
            ],
            translation: [
                'Untuk rafa\' ada empat tanda: dhammah, wawu, alif, dan nun',
                'Adapun dhammah menjadi tanda rafa\' di empat tempat',
                'Pada isim mufrad, jam\' taksir, jam\' muannats salim, dan fi\'il mudhari\'',
                'Adapun wawu menjadi tanda rafa\' di dua tempat: pada jam\' mudzakkar salim dan asma\' khamsah',
            ],
            footnotes: [
                'Empat tanda rafa\': dhammah (ـُ), wawu (ـو), alif (ـا), nun (ـن)',
                'Dhammah adalah tanda rafa\' yang paling umum digunakan',
                'Contoh: muhammaduN (mufrad), al-muslimUUna (jam\' taksir), al-muslimatU (jam\' muannats), yadruSU (mudhari\')',
                'Contoh wawu rafa\': al-muslimUUna (jam\' mudzakkar), abUUka (asma\' khamsah)',
            ]
        },
        {
            chapter: 4,
            title: 'Bab al-Af\'al (Pembahasan Kata Kerja)',
            content: [
                'الأفعال ثلاثة: ماض ومضارع وأمر',
                'فالماضي ما دل على زمان قبل زمانك',
                'والمضارع ما دل على زمانك أو ما بعده',
                'والأمر ما دل على طلب شيء بعد زمانك',
            ],
            translation: [
                'Fi\'il ada tiga: madhi (lampau), mudhari\' (sekarang/akan datang), dan amar (perintah)',
                'Maka madhi adalah yang menunjukkan waktu sebelum waktumu',
                'Dan mudhari\' adalah yang menunjukkan waktumu atau setelahnya',
                'Dan amar adalah yang menunjukkan permintaan sesuatu setelah waktumu',
            ],
            footnotes: [
                'Tiga pembagian fi\'il berdasarkan waktu: madhi (telah terjadi), mudhari\' (sedang/akan terjadi), amar (perintah untuk terjadi)',
                'Contoh madhi: kataba (dia telah menulis), dharaba (dia telah memukul)',
                'Contoh mudhari\': yaktubu (dia menulis/akan menulis), yadhribu (dia memukul/akan memukul)',
                'Contoh amar: uktub! (tulislah!), idhrib! (pukullah!)',
            ]
        },
        {
            chapter: 5,
            title: 'Bab Marfu\'at al-Asma\' (Isim-isim yang Dibaca Rafa\')',
            content: [
                'المرفوعات سبعة: الفاعل والمفعول الذي لم يسم فاعله',
                'والمبتدأ وخبره واسم كان وأخواتها وخبر إن وأخواتها والتابع للمرفوع',
                'فالفاعل هو الاسم المرفوع المذكور قبله فعله',
                'والمفعول الذي لم يسم فاعله هو الاسم المرفوع الذي لم يذكر معه فاعله',
            ],
            translation: [
                'Yang di-rafa\' ada tujuh: fa\'il, maf\'ul yang tidak disebutkan fa\'ilnya',
                'Dan mubtada beserta khabar-nya, isim kana dan saudara-saudaranya, khabar inna dan saudara-saudaranya, dan yang mengikuti yang marfu\'',
                'Maka fa\'il adalah isim marfu\' yang disebutkan sebelumnya fi\'ilnya',
                'Dan maf\'ul yang tidak disebutkan fa\'ilnya adalah isim marfu\' yang tidak disebutkan bersamanya fa\'ilnya',
            ],
            footnotes: [
                'Tujuh jenis isim yang di-rafa\': fa\'il, na\'ibul fa\'il, mubtada, khabar, isim kana, khabar inna, dan tabi\' marfu\'',
                'Tabi\' marfu\' adalah na\'t, \'athaf, taukid, atau badal dari kata marfu\'',
                'Contoh fa\'il: jaa-a muhammadUN (Muhammad datang)',
                'Contoh na\'ibul fa\'il: dhuriba zaidUN (Zaid dipukul)',
            ]
        },
        {
            chapter: 6,
            title: 'Bab al-Maf\'ul bihi (Objek)',
            content: [
                'المفعول به هو الاسم المنصوب الذي يقع عليه فعل الفاعل',
                'وهو ثلاثة أقسام: ظاهر ومضمر ومصدر مؤول',
                'فالظاهر نحو: ضربت زيدا',
                'والمضمر نحو: ضربته',
            ],
            translation: [
                'Maf\'ul bih adalah isim manshub yang dikenai perbuatan fa\'il',
                'Dan ia ada tiga bagian: zhahir (jelas), mudhamar (tersembunyi), dan mashdar muawwal (mashdar yang ditakwilkan)',
                'Maka yang zhahir seperti: dharabtu zaidAN (aku memukul Zaid)',
                'Dan yang mudhamar seperti: dharabtuHU (aku memukulnya)',
            ],
            footnotes: [
                'Maf\'ul bih: objek yang menerima perbuatan (seperti objek dalam bahasa Indonesia)',
                'Zhahir: kata benda jelas; mudhamar: kata ganti; mashdar muawwal: seperti anna, an',
                'Tanda nashab untuk maf\'ul bih: fathah untuk mufrad, ya untuk mutsanna/jam\'',
                'Contoh lengkap: akrama zaidUN muhammadAN (Zaid memuliakan Muhammad)',
            ]
        },
        {
            chapter: 7,
            title: 'Bab al-Mubtada\' wal Khabar (Mubtada dan Khabar)',
            content: [
                'المبتدأ هو الاسم المرفوع العاري عن العوامل اللفظية',
                'والخبر هو الاسم المرفوع المسند إليه',
                'والمبتدأ قسمان: ظاهر ومضمر',
                'فالظاهر ما تقدم ذكره والمضمر المنفصل اثنا عشر',
            ],
            translation: [
                'Mubtada adalah isim marfu\' yang kosong dari \'amil lafzhiyah',
                'Dan khabar adalah isim marfu\' yang disandarkan kepadanya',
                'Dan mubtada ada dua bagian: zhahir dan mudhamar',
                'Maka zhahir adalah yang telah disebutkan, dan mudhamar munfashil ada dua belas',
            ],
            footnotes: [
                'Mubtada: subjek kalimat nominal (jumlah ismiyah) yang tidak didahului \'amil',
                'Khabar: predikat yang memberikan keterangan tentang mubtada',
                'Contoh: muhammadUN thaalibUN (Muhammad adalah pelajar)',
                'Dhamir munfashil 12: ana, nahnu, anta, antuma, antum, anti, antunna, huwa, huma, hum, hiya, hunna',
            ]
        },
        {
            chapter: 8,
            title: 'Bab Kana wa Akhwatuha',
            content: [
                'كان وأخواتها وهي: كان وأمسى وأصبح وأضحى وظل وبات وصار وليس وما زال',
                'وما انفك وما فتئ وما برح وما دام',
                'وهذه الأفعال ترفع الاسم وتنصب الخبر',
            ],
            translation: [
                'Kana dan saudara-saudaranya yaitu: kana, amsa, ashbaha, adhha, zhalla, baata, shaara, laisa, maa zaala',
                'Dan maa infakka, maa fati-a, maa bariha, maa daama',
                'Dan fi\'il-fi\'il ini men-rafa\' isim dan men-nashab khabar',
            ],
            footnotes: [
                'Kana wa akhwatuha: 13 fi\'il yang mengubah i\'rab mubtada-khabar',
                'Men-rafa\' isim (yang awalnya mubtada), men-nashab khabar',
                'Contoh: kaana muhammadUN thaalibAN (Muhammad adalah pelajar)',
                'Kana: adalah/telah; ashbaha: menjadi di pagi; amsa: menjadi di sore; laisa: bukan',
            ]
        },
        {
            chapter: 9,
            title: 'Bab Inna wa Akhwatuha',
            content: [
                'إن وأخواتها وهي: إن وأن وكأن ولكن وليت ولعل',
                'وهذه الحروف تنصب الاسم وترفع الخبر',
                'فإن وأن للتوكيد وكأن للتشبيه ولكن للاستدراك وليت للتمني ولعل للترجي',
            ],
            translation: [
                'Inna dan saudara-saudaranya yaitu: inna, anna, ka-anna, lakinna, laita, la\'alla',
                'Dan huruf-huruf ini men-nashab isim dan men-rafa\' khabar',
                'Maka inna dan anna untuk ta\'kid (penekanan), ka-anna untuk tasybih (penyerupaan), lakinna untuk istidrak (tetapi), laita untuk tamanni (andai), dan la\'alla untuk taraji (mudah-mudahan)',
            ],
            footnotes: [
                'Inna wa akhwatuha: 6 huruf yang mengubah i\'rab mubtada-khabar',
                'Men-nashab isim (yang awalnya mubtada), men-rafa\' khabar',
                'Contoh: inna muhammadAN thaalibUN (sesungguhnya Muhammad adalah pelajar)',
                'Inna/anna: sesungguhnya; ka-anna: seolah-olah; lakinna: tetapi; laita: andai; la\'alla: mudah-mudahan',
            ]
        },
        {
            chapter: 10,
            title: 'Bab Nawasikh (Yang Menghilangkan I\'rab Asal)',
            content: [
                'النواسخ هي التي تدخل على المبتدأ والخبر فتغير إعرابهما',
                'وهي نوعان: أفعال ناسخة وحروف ناسخة',
                'فالأفعال الناسخة هي كان وأخواتها',
                'والحروف الناسخة هي إن وأخواتها',
            ],
            translation: [
                'Nawasikh adalah yang masuk pada mubtada dan khabar lalu mengubah i\'rab keduanya',
                'Dan ia ada dua jenis: af\'al nasakhah (fi\'il-fi\'il nasikh) dan huruf nasakhah (huruf-huruf nasikh)',
                'Maka af\'al nasakhah adalah kana dan saudara-saudaranya',
                'Dan huruf nasakhah adalah inna dan saudara-saudaranya',
            ],
            footnotes: [
                'Nawasikh: kata-kata yang mengubah i\'rab mubtada-khabar dari rafa\'-rafa\' menjadi rafa\'-nashab atau nashab-rafa\'',
                'Af\'al nasakhah (kana dkk): men-rafa\' isim, men-nashab khabar',
                'Huruf nasakhah (inna dkk): men-nashab isim, men-rafa\' khabar',
                'Kebalikan dari kana: mubtada jadi marfu\', khabar jadi manshub',
            ]
        },
        {
            chapter: 11,
            title: 'Bab al-Tawabi\' (Yang Mengikuti)',
            content: [
                'التوابع أربعة: النعت والعطف والتوكيد والبدل',
                'فالنعت تابع للمنعوت في رفعه ونصبه وخفضه وتعريفه وتنكيره وتذكيره وتأنيثه وإفراده وتثنيته وجمعه',
                'والعطف تابع متوسط بينه وبين متبوعه أحد أحرف العطف',
                'والتوكيد تابع يقرر أمر متبوعه في النسبة أو الشمول',
            ],
            translation: [
                'Tawabi\' ada empat: na\'t, \'athaf, taukid, dan badal',
                'Maka na\'t mengikuti man\'ut dalam rafa\', nashab, khafadh, ta\'rif, tankir, tadzki, ta\'nits, ifrad, tatsniyah, dan jam\'nya',
                'Dan \'athaf adalah pengikut yang dipisahkan antara dia dan matbu\'nya salah satu huruf \'athaf',
                'Dan taukid adalah pengikut yang menegaskan perkara matbu\'nya dalam perbandingan atau keseluruhan',
            ],
            footnotes: [
                'Tawabi\': empat jenis kata yang mengikuti i\'rab kata sebelumnya',
                'Na\'t (sifat): harus cocok dalam 10 hal dengan man\'ut; contoh: jaa-a rajulUN kariimUN',
                '\'Athaf: disambung dengan huruf \'athaf (wa, fa, tsumma, dll); contoh: jaa-a muhammadUN wa aliYYuN',
                'Taukid: menegaskan (nafsahu, \'ainuhu, kullun, dll); Badal: pengganti',
            ]
        },
        {
            chapter: 12,
            title: 'Khatimah (Penutup)',
            content: [
                'هذا ما يسره الله تعالى من اختصار مقدمة في النحو',
                'نسأل الله تعالى أن ينفع بها',
                'والحمد لله رب العالمين',
                'وصلى الله على سيدنا محمد وآله وصحبه أجمعين',
            ],
            translation: [
                'Inilah apa yang Allah Ta\'ala mudahkan dari ringkasan pengantar dalam ilmu Nahwu',
                'Kami memohon kepada Allah Ta\'ala agar memberi manfaat dengannya',
                'Dan segala puji bagi Allah Rabb semesta alam',
                'Dan semoga Allah memberi shalawat kepada junjungan kami Muhammad, keluarga dan para sahabatnya semuanya',
            ],
            footnotes: [
                'Khatimah: penutup kitab Al-Ajurrumiyyah',
                'Kitab ini dikarang oleh Muhammad bin Dawud Ash-Shanhaji (w. 723 H)',
                'Al-Ajurrumiyyah adalah kitab nahwu dasar yang paling masyhur di dunia Islam',
                'Kitab ini menjadi rujukan utama untuk pemula dalam belajar bahasa Arab',
            ]
        }
    ];
    ...
    const qawaidContent: KitabContent[] = [
        {
            chapter: 1,
            title: 'Al-Kalam wa Aqsamuhu (Kalam dan Pembagiannya)',
            content: [
                'الْكَلَامُ هُوَ الْقَوْلُ الْمُفِيدُ بِالْقَصْدِ',
                'وَالْكَلَامُ وَالْكَلِمُ وَالْكَلِمَةُ',
                'الْكَلِمَةُ قَوْلٌ مُفْرَدٌ',
                'الْكَلِمُ مَا تَرَكَّبَ مِنْ ثَلَاثِ كَلِمَاتٍ فَأَكْثَرَ',
            ],
            translation: [
                'Kalam adalah ucapan yang berfaidah dengan sengaja',
                'Dan kalam, kalim, dan kalimah',
                'Kalimah adalah ucapan mufrad (tunggal)',
                'Kalim adalah yang tersusun dari tiga kata atau lebih',
            ],
            footnotes: [
                'Kalam: kalimat sempurna yang memberikan faidah (makna lengkap)',
                'Tiga istilah: kalimah (kata), kalim (3+ kata), kalam (kalimat sempurna)',
                'Contoh kalimah: muhammadun; Contoh kalam: muhammadun qaa-imun',
                'Kalam terdiri dari isim, fi\'il, dan huruf yang berfaidah',
            ]
        },
        {
            chapter: 2,
            title: 'Al-Isim wa Alamatuhu (Isim dan Tanda-tandanya)',
            content: [
                'الِاسْمُ كَلِمَةٌ تَدُلُّ عَلَى مَعْنًى فِي نَفْسِهَا',
                'وَلَا تَقْتَرِنُ بِزَمَانٍ',
                'وَعَلَامَاتُهُ: الْجَرُّ وَالتَّنْوِينُ وَالنِّدَاءُ وَأَلْ',
                'وَالْإِسْنَادُ إِلَيْهِ',
            ],
            translation: [
                'Isim adalah kata yang menunjukkan makna pada dirinya sendiri',
                'Dan tidak berkaitan dengan waktu',
                'Dan tanda-tandanya: jarr, tanwin, nida, dan alif lam',
                'Dan isnad (predikat) kepadanya',
            ],
            footnotes: [
                'Isim: kata benda yang tidak menunjukkan waktu (berbeda dengan fi\'il)',
                'Contoh: muhammadun, al-kitabu, rajulun',
                'Tanda isim: menerima kasrah (jarr), tanwin, ya nida, al, dan bisa jadi mubtada',
                'Isnad: bisa dijadikan mubtada yang mendapat khabar',
            ]
        },
        {
            chapter: 3,
            title: 'Al-Fi\'il wa Anwa\'uhu (Fi\'il dan Jenisnya)',
            content: [
                'الْفِعْلُ كَلِمَةٌ تَدُلُّ عَلَى مَعْنًى فِي نَفْسِهَا',
                'مُقْتَرِنَةٌ بِأَحَدِ الْأَزْمِنَةِ الثَّلَاثَةِ',
                'الْمَاضِي وَالْمُضَارِعُ وَالْأَمْرُ',
            ],
            translation: [
                'Fi\'il adalah kata yang menunjukkan makna pada dirinya sendiri',
                'Yang berkaitan dengan salah satu dari tiga waktu',
                'Madhi, mudhari\', dan amar',
            ],
            footnotes: [
                'Fi\'il: kata kerja yang menunjukkan waktu terjadinya perbuatan',
                'Tiga waktu: madhi (lampau), mudhari\' (sekarang/akan datang), amar (perintah)',
                'Contoh madhi: kataba (telah menulis), contoh mudhari\': yaktubu (menulis)',
                'Contoh amar: uktub (tulislah!)',
            ]
        },
        {
            chapter: 4,
            title: 'Al-Harf wa Ma\'anihi (Huruf dan Maknanya)',
            content: [
                'الْحَرْفُ كَلِمَةٌ لَا تَدُلُّ عَلَى مَعْنًى فِي نَفْسِهَا',
                'بَلْ فِي غَيْرِهَا',
                'وَلَا عَلَامَةَ لَهُ',
            ],
            translation: [
                'Huruf adalah kata yang tidak menunjukkan makna pada dirinya sendiri',
                'Tetapi pada selainnya',
                'Dan tidak ada tanda khusus untuknya',
            ],
            footnotes: [
                'Huruf: partikel yang baru bermakna jika bergabung dengan kata lain',
                'Contoh: fi (di), min (dari), ila (ke), wa (dan), fa (maka)',
                'Huruf tidak memiliki tanda khusus seperti isim dan fi\'il',
                'Huruf dikenali dengan proses eliminasi: bukan isim dan bukan fi\'il',
            ]
        },
        {
            chapter: 5,
            title: 'Al-I\'rab wa Aqsamuhu (I\'rab dan Pembagiannya)',
            content: [
                'الْإِعْرَابُ تَغْيِيرٌ يَلْحَقُ آخِرَ الْكَلِمَةِ',
                'لِاخْتِلَافِ الْعَوَامِلِ الدَّاخِلَةِ عَلَيْهَا',
                'أَقْسَامُهُ أَرْبَعَةٌ: رَفْعٌ وَنَصْبٌ وَجَرٌّ وَجَزْمٌ',
            ],
            translation: [
                'I\'rab adalah perubahan yang terjadi pada akhir kata',
                'Karena perbedaan \'amil yang masuk padanya',
                'Pembagiannya ada empat: rafa\', nashab, jarr, dan jazm',
            ],
            footnotes: [
                'I\'rab: perubahan harakat akhir kata karena pengaruh \'amil (kata yang mempengaruhi)',
                'Empat jenis i\'rab: rafa\' (dhammah), nashab (fathah), jarr (kasrah), jazm (sukun)',
                'Isim bisa rafa\', nashab, jarr; Fi\'il bisa rafa\', nashab, jazm',
                'Contoh: muhammadUN (rafa\'), muhammadAN (nashab), muhammadIN (jarr)',
            ]
        },
        {
            chapter: 6,
            title: 'Al-Binaa\' (Bina)',
            content: [
                'الْبِنَاءُ لُزُومُ آخِرِ الْكَلِمَةِ حَالَةً وَاحِدَةً',
                'لِغَيْرِ عَامِلٍ وَلَا اعْتِلَالٍ',
                'وَهُوَ أَرْبَعَةُ أَنْوَاعٍ',
            ],
            translation: [
                'Bina adalah tetapnya akhir kata pada satu keadaan',
                'Bukan karena \'amil dan bukan karena i\'lal',
                'Dan ia ada empat jenis',
            ],
            footnotes: [
                'Bina: akhir kata tidak berubah meskipun posisinya berubah dalam kalimat',
                'Empat jenis bina: sukun, fathah, kasrah, dhammah',
                'Contoh: haa-ulaa-i (ini/mereka) selalu sama, kaDZaa (begitu) selalu sama',
                'Berbeda dengan mu\'rab yang berubah sesuai posisi dalam kalimat',
            ]
        },
        {
            chapter: 7,
            title: 'Al-Ma\'rifah wan Nakirah (Ma\'rifah dan Nakirah)',
            content: [
                'النَّكِرَةُ مَا وُضِعَ لِشَيْءٍ لَا بِعَيْنِهِ',
                'وَالْمَعْرِفَةُ مَا وُضِعَ لِشَيْءٍ بِعَيْنِهِ',
                'وَالْمَعَارِفُ سَبْعَةٌ',
            ],
            translation: [
                'Nakirah adalah yang diletakkan untuk sesuatu yang tidak tertentu',
                'Dan ma\'rifah adalah yang diletakkan untuk sesuatu yang tertentu',
                'Dan ma\'rifah ada tujuh jenis',
            ],
            footnotes: [
                'Nakirah: kata benda umum/tidak tertentu; Ma\'rifah: kata benda tertentu/khusus',
                'Contoh nakirah: rajulun (seorang lelaki), kitaabun (sebuah buku)',
                'Tujuh ma\'rifah: dhamir, \'alam, isim isyarah, isim mawshul, ma\'rif bil alif-lam, mudhaf ke ma\'rifah, nakirah yang dinida',
                'Contoh ma\'rifah: huwa (dhamir), muhammadun (\'alam), al-kitabu (ber-al)',
            ]
        },
        {
            chapter: 8,
            title: 'Al-\'Adad (Bilangan)',
            content: [
                'الْعَدَدُ مَا دَلَّ عَلَى مِقْدَارِ الْمَعْدُودِ',
                'وَهُوَ ثَلَاثَةُ أَقْسَامٍ',
                'أَصْلِيٌّ وَتَرْتِيبِيٌّ وَكِنَائِيٌّ',
            ],
            translation: [
                'Bilangan adalah yang menunjukkan jumlah sesuatu yang dihitung',
                'Dan ia ada tiga bagian',
                'Ashliy (pokok), tartiibiy (urutan), dan kinaai (sindiran)',
            ],
            footnotes: [
                '\'Adad: angka/bilangan dalam bahasa Arab dengan aturan khusus',
                'Ashliy: satu, dua, tiga (waahid, itsnaan, tsalaatsah)',
                'Tartiibiy: pertama, kedua, ketiga (awwal, tsaani, tsaalits)',
                'Kinaai: beberapa, banyak (kam, ba\'dh, katsiirun)',
            ]
        },
        {
            chapter: 9,
            title: 'Al-Jumal (Kalimat)',
            content: [
                'الْجُمْلَةُ قَوْلٌ مُؤَلَّفٌ مِنْ كَلِمَتَيْنِ',
                'أُسْنِدَتْ إِحْدَاهُمَا إِلَى الْأُخْرَى',
                'وَهِيَ قِسْمَانِ: اسْمِيَّةٌ وَفِعْلِيَّةٌ',
            ],
            translation: [
                'Jumlah adalah ucapan yang tersusun dari dua kata',
                'Yang salah satunya disandarkan kepada yang lain',
                'Dan ia ada dua bagian: ismiyyah dan fi\'liyyah',
            ],
            footnotes: [
                'Jumlah: kalimat dalam bahasa Arab, minimal 2 kata yang saling berhubungan',
                'Jumlah ismiyyah: dimulai dengan isim (mubtada-khabar)',
                'Jumlah fi\'liyyah: dimulai dengan fi\'il (fi\'il-fa\'il)',
                'Contoh ismiyyah: muhammadun thaalibun; Contoh fi\'liyyah: dharaba muhammadun',
            ]
        },
        {
            chapter: 10,
            title: 'Al-Maf\'ulat (Objek-objek)',
            content: [
                'الْمَفَاعِيلُ خَمْسَةٌ',
                'مَفْعُولٌ بِهِ وَمَفْعُولٌ مُطْلَقٌ',
                'وَمَفْعُولٌ فِيهِ وَمَفْعُولٌ لَهُ وَمَفْعُولٌ مَعَهُ',
            ],
            translation: [
                'Mafa\'il ada lima',
                'Maf\'ul bih dan maf\'ul muthlaq',
                'Dan maf\'ul fiih, maf\'ul lahu, dan maf\'ul ma\'ahu',
            ],
            footnotes: [
                'Mafa\'il: lima jenis objek/pelengkap dalam kalimat yang di-nashab',
                'Maf\'ul bih: objek langsung (dharaba muhammadun zaidAN)',
                'Maf\'ul muthlaq: mashdar (dharaba dharBAN); Maf\'ul fiih: keterangan waktu/tempat',
                'Maf\'ul lahu: tujuan; Maf\'ul ma\'ahu: yang menyertai (jaa-a muhammadun wa as-sabaaHA)',
            ]
        },
        {
            chapter: 11,
            title: 'Al-Hal (Keadaan)',
            content: [
                'الْحَالُ وَصْفٌ فَضْلَةٌ مُنْتَصِبٌ',
                'يَبِينُ هَيْئَةَ مَا انْتَصَبَ عَنْهُ',
                'وَصَاحِبُهَا فَاعِلٌ أَوْ مَفْعُولٌ',
            ],
            translation: [
                'Hal adalah sifat tambahan yang di-nashab',
                'Yang menjelaskan keadaan apa yang di-nashab darinya',
                'Dan shahibnya adalah fa\'il atau maf\'ul',
            ],
            footnotes: [
                'Hal: keterangan keadaan yang menjelaskan kondisi fa\'il atau maf\'ul',
                'Hal selalu di-nashab dan biasanya nakirah',
                'Contoh: jaa-a muhammadun raakibAN (Muhammad datang dalam keadaan mengendarai)',
                'Shahib al-hal: yang dijelaskan keadaannya (muhammadun dalam contoh)',
            ]
        },
        {
            chapter: 12,
            title: 'Al-Tamyiz (Penjelasan)',
            content: [
                'التَّمْيِيزُ اسْمٌ نَكِرَةٌ مَنْصُوبٌ',
                'يُبَيِّنُ مَا قَبْلَهُ مِنْ إِبْهَامٍ',
                'وَهُوَ قِسْمَانِ: تَمْيِيزُ ذَاتٍ وَتَمْيِيزُ نِسْبَةٍ',
            ],
            translation: [
                'Tamyiz adalah isim nakirah yang di-nashab',
                'Yang menjelaskan apa sebelumnya dari kesamaran',
                'Dan ia ada dua bagian: tamyiz dzat dan tamyiz nisbah',
            ],
            footnotes: [
                'Tamyiz: kata yang menjelaskan/membedakan sesuatu yang masih samar',
                'Contoh: isyruuna kitaabAN (20 buku) - kitaaban adalah tamyiz',
                'Tamyiz dzat: menjelaskan bilangan/ukuran; Tamyiz nisbah: menjelaskan hubungan',
                'Contoh nisbah: muhammadun ahsanu wajHAN (Muhammad lebih bagus wajahnya)',
            ]
        },
        {
            chapter: 13,
            title: 'Al-Istithna\' (Pengecualian)',
            content: [
                'الِاسْتِثْنَاءُ إِخْرَاجُ بَعْضٍ مِنْ كُلٍّ',
                'بِإِلَّا أَوْ إِحْدَى أَخَوَاتِهَا',
                'وَأَدَوَاتُهُ ثَمَانِيَةٌ',
            ],
            translation: [
                'Istitsna adalah mengeluarkan sebagian dari keseluruhan',
                'Dengan illa atau salah satu saudara-saudaranya',
                'Dan alatnya ada delapan',
            ],
            footnotes: [
                'Istitsna: kalimat pengecualian (kecuali/selain)',
                'Delapan adawat: illa, ghaira, siwa, \'ada, khaala, haasya, laysa, laa yakuunu',
                'Contoh: jaa-a ath-thullabu ILLA zaidAN (para pelajar datang kecuali Zaid)',
                'Mustatsna (yang dikecualikan) bisa nashab, rafa\', atau jarr tergantung konteks',
            ]
        },
        {
            chapter: 14,
            title: 'Al-\'Atf (Athaf)',
            content: [
                'حُرُوفُ الْعَطْفِ تِسْعَةٌ',
                'الْوَاوُ وَالْفَاءُ ثُمَّ وَأَوْ وَأَمْ',
                'بَلْ وَلَكِنْ وَلَا وَحَتَّى',
            ],
            translation: [
                'Huruf \'athaf ada sembilan',
                'Waw, fa, tsumma, aw, dan am',
                'Bal, lakin, la, dan hatta',
            ],
            footnotes: [
                '\'Athaf: menghubungkan dua kata dengan huruf penghubung',
                'Waw (dan): jaa-a muhammadun wa aliYYuN; Fa (lalu): maka; Tsumma (kemudian)',
                'Aw (atau): pilihan; Am (atau): pertanyaan; Bal (bahkan): istidrak',
                'Ma\'thuf mengikuti i\'rab ma\'thuf \'alaih',
            ]
        },
        {
            chapter: 15,
            title: 'Al-Badal (Pengganti)',
            content: [
                'الْبَدَلُ تَابِعٌ مَقْصُودٌ بِالْحُكْمِ',
                'بِلَا وَاسِطَةٍ',
                'وَهُوَ أَرْبَعَةُ أَقْسَامٍ',
                'بَدَلُ كُلٍّ مِنْ كُلٍّ وَبَدَلُ بَعْضٍ مِنْ كُلٍّ',
            ],
            translation: [
                'Badal adalah pengikut yang dimaksudkan oleh hukum',
                'Tanpa perantara',
                'Dan ia ada empat bagian',
                'Badal kul min kul dan badal ba\'dh min kul',
            ],
            footnotes: [
                'Badal: kata pengganti yang dimaksud sebenarnya (bukan yang pertama)',
                'Empat jenis: kul min kul (semua dari semua), ba\'dh min kul (sebagian dari semua)',
                'Isytimal (mengandung), mubayyin (menjelaskan)',
                'Contoh: jaa-a akhUUka muhammadUN (kakakmu Muhammad datang) - muhammadun badal',
            ]
        }
    ];
